...
const swaggerDef = {
  ...
  info: {
    ...
    description:
      ...
      "+ Update model <strong>Fault</strong> with new fields <strong>category ('LoggerFault', 'Solar365Fault'), type ('Error', 'Warning'), event ('Devices', 'MPPT', 'String'), description</strong><br/>" +
